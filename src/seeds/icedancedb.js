const icedance = [
  ...
  },
  {
    ...
    discipline: "icedance",
    country: "France",
    record: "French nationals four-time silver medalists",
    description:
      "They pale in comparison to their teammates and rinkmates Papadakis and Cizeron but I still think they're great. They're fun too watch, have some good skating skills and cool, creative elements. Watch out for theire signature TOUPIE!",
    sp: "Les Demoiselles de Rochefort",
    fs: "Harmonium - Histoires sans paroles",
    image:
  ...
  },
  {
    ...
    discipline: "icedance",
    country: "France",
    record: "They're a new pair, so they don't have any medals yet!",
    description:
      "My friend Lucie and I actually saw a movie about Pierre Souquet and his former partner, Lorenza Alessandrini. Lorenza retired and Pierre teamed up with Julia instead. In the movie, Pierre and Lorenza express their frustration with their career never quite taking off despite all their efforts. Julia and Pierre are a brand new pair and a host pick here, so we shouldn't expect miracles from them. I just hope they skate cleanly and get valuable international experience together.",
    sp: "Singin' in the Rain",
    fs: "Benjamin Clementine - The People and I, Nemesis",
  ...
  },
  {
    ...
    discipline: "icedance",
    country: "Spain",
    record: "2018 Spanish national champions",
    description:
      "They were already in Grenoble last year but unfortunately they didn't do well. Not my favorite team, but I hope they change my mind.",
    sp: "Grease soundtrack",
    fs: "My one and only love, Larrons En Foire",
    image:
  ...
  },
  {
    ...
    country: "USA",
    record:
      "Four Continents champions, two-time Grand Prix Final silver medalists, 2015 Worlds silver medalists, 2015 US national champions",
    description:
      "They're a great team and Madison is beautiful, but I could never quite connect to their skating. I appreciate their skills but I feel nothing when I watch them. Their free dance for the season is very, erm, culturally insensitive, so I have a feeling this is going to be another year of me not being a fan of theirs.",
    sp: "Too Darn Hot from Kiss Me Kate",
    fs: "Embarrassing oriental medley",
    image:
